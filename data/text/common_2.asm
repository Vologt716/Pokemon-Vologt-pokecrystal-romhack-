...
_OakText1::
	...
	para "My name is"
	line "ULYSSES WYBURNUM."

	para "People call me the"
	line "Professor WYBURNUM"
	prompt

_OakText2::
	text "Looks like you're"
	line "going to take part"
	cont "in the VOLOGT"
	cont "#MON show.@"
	text_end
...
_OakText4::
	...
	para "Hundreds of train-"
	line "ers from all over"
	cont "the world come to"
	cont "the VOLOGT region"
	cont "every year."

	para "Some just to have"
	line "fun with #MON,"
	cont "and some to win"
	cont "the grand prize!"
	prompt

_OakText5::
	text "Like any other"
	line "large-scale event,"
	cont "we have our own"
	cont "rules."

	para "First of all you"
	line "are not allowed to"
	cont "bring #MON with"
	cont "you."

	para "We have both"
	line "professional cham-"
	cont "pions and novice"
	cont "trainers on equal"
	cont "terms."
	prompt
