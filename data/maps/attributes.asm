...
ENDM
	...
	map_attributes FarmGate, FARM_GATE, $00, 0
	map_attributes StartersFarm, STARTERS_FARM, $00, 0
	map_attributes EmployeesOnly, EMPLOYEES_ONLY, $00, 0
	map_attributes ShortCut, SHORT_CUT, $00, 0
