...
MapGroup_NewBark:
	...
	map PlayersHouse1F, TILESET_PLAYERS_HOUSE, INDOOR, LANDMARK_CITY_A, MUSIC_PALLET_TOWN, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map PlayersHouse2F, TILESET_PLAYERS_ROOM, INDOOR, LANDMARK_CITY_A, MUSIC_PALLET_TOWN, FALSE, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup_FirstVologt:
	...
	map AlphaTown, TILESET_KANTO, TOWN, LANDMARK_CITY_A, MUSIC_PALLET_TOWN, FALSE,PALETTE_AUTO, FISHGROUP_SHORE
	map RoutePsi, TILESET_KANTO, ROUTE, LANDMARK_ROUTE_47, MUSIC_ROUTE_1, FALSE,PALETTE_AUTO, FISHGROUP_SHORE
	map BetaTown, TILESET_KANTO, TOWN, LANDMARK_CITY_B, MUSIC_PALLET_TOWN, FALSE,PALETTE_AUTO, FISHGROUP_SHORE
	map RouteOmega, TILESET_KANTO, ROUTE, LANDMARK_ROUTE_48, MUSIC_ROUTE_1, FALSE,PALETTE_AUTO, FISHGROUP_SHORE
	map GammaTown, TILESET_KANTO, TOWN, LANDMARK_CITY_C, MUSIC_PALLET_TOWN, FALSE,PALETTE_AUTO, FISHGROUP_SHORE
	map UwsLab, TILESET_LAB, INDOOR, LANDMARK_CITY_A, MUSIC_POKEMON_TALK, FALSE, PALETTE_DAY, FISHGROUP_SHORE
