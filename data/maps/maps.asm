...
MapGroup_Viridian:
	...
	map Route22, TILESET_KANTO, ROUTE, LANDMARK_ROUTE_22, MUSIC_ROUTE_1, FALSE, PALETTE_AUTO, FISHGROUP_POND
...
MapGroup_NewBark:
	...
	map Route29, TILESET_KANTO, ROUTE, LANDMARK_ROUTE_29, MUSIC_ROUTE_1, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map NewBarkTown, TILESET_KANTO, TOWN, LANDMARK_NEW_BARK_TOWN, MUSIC_PALLET_TOWN, FALSE, PALETTE_AUTO, FISHGROUP_OCEAN
	map ElmsLab, TILESET_LAB, INDOOR, LANDMARK_NEW_BARK_TOWN, MUSIC_POKEMON_TALK, FALSE, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup_Cherrygrove:
	...
	map CherrygroveCity, TILESET_KANTO, TOWN, LANDMARK_CHERRYGROVE_CITY, MUSIC_PALLET_TOWN, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map CherrygroveMart, TILESET_MART, INDOOR, LANDMARK_CHERRYGROVE_CITY, MUSIC_PALLET_TOWN, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	...
	map MrPokemonsHouse, TILESET_FACILITY, INDOOR, LANDMARK_ROUTE_22, MUSIC_CHERRYGROVE_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup_FirstVologt:
	table_width MAP_LENGTH, MapGroup_FirstVologt
	map FarmGate, TILESET_GATE, INDOOR, LANDMARK_ROUTE_22, MUSIC_PROF_ELM, TRUE, PALETTE_DAY, FISHGROUP_SHORE
	map StartersFarm, TILESET_FOREST, CAVE, LANDMARK_ROUTE_22, MUSIC_ROUTE_2, TRUE, PALETTE_AUTO, FISHGROUP_SHORE
	map EmployeesOnly, TILESET_CAVE, CAVE, LANDMARK_SHORT_CUT, MUSIC_MT_MOON, TRUE, PALETTE_NITE, FISHGROUP_SHORE
	map ShortCut, TILESET_RUINS_OF_ALPH, CAVE, LANDMARK_SHORT_CUT, MUSIC_MT_MOON, TRUE, PALETTE_NITE, FISHGROUP_SHORE
	assert_table_length NUM_FIRST_VOLOGT_MAPS
